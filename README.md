...
## Environments
- Preview: https://main--my-eds-template--nihartekno.aem.page/
- Live: https://main--my-eds-template--nihartekno.aem.live/
...
1. Open the `my-eds-template` directory in your favorite IDE and start coding :)
